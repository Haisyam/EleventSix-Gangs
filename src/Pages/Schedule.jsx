...
const Schedule = () => {
  ...
  piketGroup = [
    ["Ais", "Amelia", "Anisa", "Camelia", "Aldi", "Alif", "Andika"],
    ["Ela", "Fuji", "Intan", "Jahra", "Andika P.", "Anwar", "Bambang"],
    ["Laela", "Lina", "Nadina", "Asep", "Fedlin", "Sahran", "Moga"],
    ["Putri", "Naila", "Rima", "Riya", "Huda", "Nurfadli", "Muji"],
    ["Selfi", "Yesa", "Yuli", "Nazly", "Radja", "Riyan", "Moh. Adi"],
  ];
