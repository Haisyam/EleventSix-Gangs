      ...
      <div className="flex flex-col justify-center items-center">
        ...
        >
          <div className="flex-col">
            <BorderStruktur Jabatan="Sekertaris" Nama="Yulia" Width="120px" />
            <div className="py-[3%]"></div>
            <BorderStruktur Jabatan="" Nama="Anisa Hidayati" Width="120px" />
          </div>

          <div className="flex-col">
            <BorderStruktur Jabatan="Bendahara" Nama="Jahra" Width="120px" />
            <div className="py-[3%]"></div>
            <BorderStruktur Jabatan="" Nama="Ela Lisdiana" Width="120px" />
          </div>
        </div>
        ...
        >
          <div className="flex-col">
            ...
            />
            <div className="py-[3%]"></div>
            <BorderStruktur Jabatan="" Nama="Fauzziyah" Width="120px" />
          </div>
          ...
          <div className="flex-col">
            ...
            />
            <div className="py-[3%]"></div>
            <BorderStruktur Jabatan="" Nama="Rima Sabela" Width="120px" />
          </div>

          <div className="flex-col hidden lg:flex">
            <BorderStruktur Jabatan="Keamanan" Nama="Moh. Adi" Width="120px" />
            <div className="py-[3%]"></div>
            <BorderStruktur Jabatan="" Nama="Selvy Novia R." Width="120px" />
          </div>
        </div>
        ...
        <div
          className=" absolute bottom-[15%] lg:bottom-[20%] "
          data-aos="fade-up"
          data-aos-duration="1000"
        >
          <div className="flex justify-center items-center flex-col">
            ...
            <div className="relative bottom-3">
              <BorderStruktur
                ...
                Width="120px"
              />
              <BorderStruktur Jabatan="" Nama="Sahran Fadilah" Width="120px" />
            </div>
          </div>
        </div>
